        ...
        <div className='container relative z-10'>
          <div ref={ref} className='flex flex-col gap-8'>
            ...
            <div
              ...
              <p className='max-w-38 text-dark_black/60 dark:text-white/60 mt-4'>
                SDE at WizCommerce | Building enterprise solutions serving 85+ US clients.
                Experienced in React, Next.js, Node.js & high-performance systems
                processing 50,000+ updates monthly.
              </p>
            </div>
