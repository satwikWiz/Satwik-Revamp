...
export const metadata: Metadata = {
    title: "Privacy Policy | Satwik Kanhere",
    description: "Privacy Policy for Satwik Kanhere's portfolio website. Learn how your information is collected, used, and protected.",
    robots: {
        index: true,
        follow: true,
    },
